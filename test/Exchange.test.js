        ...
        describe('filling order', async () => {
            ...
            describe('succees', async () => {
                ...
                it('executes the trade and charges fee', async () => {
                    ...
                    balance.toString().should.equal(ether(0).toString(), 'user1 deducted ether')
                    balance = await exchange.balanceOf(token.address, user2)
                    balance.toString().should.equal(tokens(0.9).toString(), 'user2 deducted tokens') //2 - 1.1 = 0.9
                    
                    const feeAccount = await exchange.feeAccount()
                    balance = await exchange.balanceOf(token.address, feeAccount)
                    balance.toString().should.equal(tokens(0.1).toString(), 'fee applied')
        ...
        describe('cancelling orders', () => {
            ...
            describe('success', () => {
                ...
                it('cancels the order', async () => {
                    ...
                    const cancelledOrder = await exchange.ordersCancelled(1)
